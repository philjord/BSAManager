...
public class DDS_HEADER
{
	...
	DDS_PIXELFORMAT DDSPF_ATI1 = new DDS_PIXELFORMAT(8 * 4, DDS_FOURCC, MAKEFOURCC('A', 'T', 'I', '1'), 0, 0, 0, 0, 0);

	DDS_PIXELFORMAT DDSPF_ATI2 = new DDS_PIXELFORMAT(8 * 4, DDS_FOURCC, MAKEFOURCC('A', 'T', 'I', '2'), 0, 0, 0, 0, 0);
	
	DDS_PIXELFORMAT DDSPF_BC5U = new DDS_PIXELFORMAT(8 * 4, DDS_FOURCC, MAKEFOURCC('B', 'C', '5', 'U'), 0, 0, 0, 0, 0);

	DDS_PIXELFORMAT DDSPF_BC5S = new DDS_PIXELFORMAT(8 * 4, DDS_FOURCC, MAKEFOURCC('B', 'C', '5', 'S'), 0, 0, 0, 0, 0);
	...
	static final int DXGI_FORMAT_UNKNOWN = 0, DXGI_FORMAT_R32G32B32A32_TYPELESS = 1, DXGI_FORMAT_R32G32B32A32_FLOAT = 2,
	...
	static final int DXGI_FORMAT_R8_UINT = 62, DXGI_FORMAT_R8_SNORM = 63, DXGI_FORMAT_R8_SINT = 64, DXGI_FORMAT_A8_UNORM = 65, DXGI_FORMAT_R1_UNORM = 66,
	...
	static final int DXGI_FORMAT_FORCE_UINT = 0xffffffff;
